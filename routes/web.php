...
Route::get('/', function () {
    ...
    return view('user.dashboard.index', compact('books', 'categories'));
})->name('home');
...
Route::post('/midtrans/notification', [User\OrderController::class, 'notification'])
...
Route::middleware(['auth', 'admin'])
    ...
    ->group(function () {
        ...
        Route::resource('shipping', Admin\ShippingCostController::class)
